...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Psych Engine Android Port'],
            ['Potionion', 'potionion', 'director, artist, charter, ate 4 hotdogs in 2 minutes', 'https://twitter.com/Potionion', '0xFF3c3c42'],
            ['ghostoru', 'oru', 'musician, better than p', 'https://twitter.com/pex_ton/status/1594070412606189569', '0xFF572a33'],
			['diples', 'diples', 'coder', 'https://jaquin.net/bed%20kiss.gif', '0xFF979ca8'],
            ['uniimations', 'unii', 'coder but worse', 'https://twitter.com/UniiAnimates', '0xFFbf1972'],
			[''],
